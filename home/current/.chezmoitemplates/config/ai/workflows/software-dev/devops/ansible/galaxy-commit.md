...
Do the following Once, by RUNNING GIT FROM WITHIN EACH OF THESE DIRECTORIES:
- D:\p\gh\lrepo52\mrepo\proj\homenet\deployment-operations\3rdparty\gh\levonk\levonk-ansible-galaxy
- D:\p\gh\lrepo52\mrepo\proj\homenet\deployment-operations

1. Look at the files within BOTH repositories that have been changed and not committed.
2. run any registered linter, formatter, and finally unit tests if available.
