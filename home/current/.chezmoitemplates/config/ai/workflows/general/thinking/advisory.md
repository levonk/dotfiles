...
synopsis: "An AI workflow that generates coaching guides. If given multiple experts, it simulates an advisory panel, synthesizing diverse perspectives to solve a user's problem."
