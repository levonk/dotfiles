## From running `COMPLETE=bash treemd`
_clap_complete_treemd() {
    local IFS=$'\013'
...
if [[ "${BASH_VERSINFO[0]}" -eq 4 && "${BASH_VERSINFO[1]}" -ge 4 || "${BASH_VERSINFO[0]}" -gt 4 ]]; then
    complete -o nospace -o bashdefault -o nosort -F _clap_complete_treemd treemd
else
    complete -o nospace -o bashdefault -F _clap_complete_treemd treemd
fi
