...
__POWERLEVEL10K="${__ZSH_PLUGINS_DIR}/powerlevel10k/powerlevel10k.zsh"
if [[ -r "${__POWERLEVEL10K}" ]]; then
  # shellcheck disable=SC1091  # Managed by chezmoi externals
  source "${__POWERLEVEL10K}"
fi
