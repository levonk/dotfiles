...
1. commit any changes that need to be committed (without running tests again, as chezmoi needs fiels committed to use them, and you would only test old files otherwise)
